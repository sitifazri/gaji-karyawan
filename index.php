...
$query = "SELECT karyawan.*, rating.rating, rating.presentase_bonus 
          FROM karyawan 
          JOIN rating ON karyawan.id_rating = rating.id 
...
<body>
    <div class="container">
        ...
        <div class="main">
            <div class="header">
                <h1><img src="img/PT.png" alt="Logo PT" class="pt">WELCOME SITI&DiO COMPANY</h1>
            ...
            <table>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        $bonus = floatval($row['presentase_bonus']);

                        echo "<tr>
                            <td>{$no}</td>
                            <td>" . htmlspecialchars($nama) . "</td>
                            <td>" . str_repeat("⭐", $rating) . "</td>
                            <td>{$bonus}%</td>
                        </tr>";
                        $no++;
                    }
