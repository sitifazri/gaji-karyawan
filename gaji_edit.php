...
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM gaji WHERE id = '$id'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update = mysqli_query($koneksi, "UPDATE gaji SET id_karyawan='$id_karyawan', id_jabatan='$id_jabatan', total_pendapatan='$total_pendapatan' WHERE id='$id'");
    ...
    <form method="POST">
        ...
        <select name="id_karyawan" required>
            <?php while ($row = mysqli_fetch_assoc($karyawan)) { ?>
                <option value="<?= $row['id'] ?>" <?= $row['id'] == $gaji['id_karyawan'] ? 'selected' : '' ?>>
                    <?= $row['nama'] ?>
                </option>
            <?php } ?>
        </select><br>
        ...
        <select name="id_jabatan" required>
            <?php while ($row = mysqli_fetch_assoc($jabatan)) { ?>
                <option value="<?= $row['id'] ?>" <?= $row['id'] == $gaji['id_jabatan'] ? 'selected' : '' ?>>
                    <?= $row['nama'] ?>
                </option>
            <?php } ?>
        </select><br>
        ...
        <input type="number" name="total_pendapatan" value="<?= $gaji['total_pendapatan'] ?>" required><br>
